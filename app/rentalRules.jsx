...
const rentalRules = () => {
  ...
  return (
    <View className='bg-dark-200 flex-1'>
          <Text className='text-primary text-center font-Handlee text-2xl'>
            Rules
          </Text>
        <View className='mt-3 py-4 flex-row justify-between border-primary rounded-xl mx-3' style={{borderWidth:1}}>
          ...
          <View className='mr-8 justify-around'>
            <Text className='text-primary text-md font-QuickSand'>{carListings[detailsIndex].state} , {carListings[detailsIndex].country}</Text>
            <Text className='w-full text-md text-primary font-QuickSand'>{carListings[detailsIndex].reviewStore} <FontAwesomeIcon icon={faStar} size={13} color='#ff934f'/></Text>
